...
// -------------------------------------------------------------------COMMENT -------------------------------------------------------------------
    ...
    // '17' - Блок кода, выводим операции(operations) и подключаем модернизировануую 'key=func' которая дает доступ к свойствам, блогодаря этому каждое свойство выполняется по очереди не перемешиваясь с друг-другом, коротко говоря этот ход не поломает код и выведет правильно результат по запросу
// -----------------------------------------------------------------------------------------------------------------------------------------------
